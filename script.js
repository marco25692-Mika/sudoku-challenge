...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Prüfen, ob das Spiel über einen Freund-Link aufgerufen wurde
    ...
    if (duellCode) {
        ...
        setTimeout(() => {
            alert(`Du wurdest zu einer Sudoku-Challenge (${getDifficultyName(currentDifficulty)}) herausgefordert! Viel Erfolg!`);
            startGame();
        }, 500);
    }
});
...
function setupEventListeners() {
    ...
    // NEU: Klick auf "Rätsel Starten" öffnet Abfrage (Rangliste oder Freund herausfordern)
...
// NEU: Auswahl-Dialog nach Klick auf "Rätsel Starten"
    ...
    overlay.innerHTML = `
        <div class="ad-container" style="max-width: 340px; text-align: center; position: relative; padding: 24px;">
            ...
            <div style="display: flex; flex-direction: column; gap: 12px;">
                <button id="mode-ranking" class="btn btn-primary" style="padding: 14px; border-radius: 12px; font-weight: 600; cursor: pointer;">🏆 Allgemeine Rangliste</button>
